...
output "label_id" {
  description = "Disambiguated ID from the label module"
  value       = module.label.id
}

output "label_tags" {
  description = "Normalized tag map from the label module"
  value       = module.label.tags
}

output "label_context" {
  description = "Context of the label module to pass to other label modules"
...
output "protected_subnet_objects" {
  description = "A list of all protected subnets, containing the full objects."
...
output "protected_subnet_arns" {
  description = "List of ARNs of protected subnets"
  value       = aws_subnet.protected[*].arn
}

output "protected_subnets_cidr_blocks" {
  description = "List of cidr_blocks of protected subnets"
  value       = compact(aws_subnet.protected[*].cidr_block)
}

output "protected_subnets_ipv6_cidr_blocks" {
  description = "List of IPv6 cidr_blocks of protected subnets in an IPv6 enabled VPC"
  value       = compact(aws_subnet.protected[*].ipv6_cidr_block)
}

output "protected_route_table_ids" {
  description = "List of IDs of protected route tables"
  value       = local.protected_route_table_ids
}
...
output "protected_network_acl_id" {
  description = "ID of the protected network ACL"
  value       = try(aws_network_acl.protected[0].id, null)
}

output "protected_network_acl_arn" {
  description = "ARN of the protected network ACL"
  value       = try(aws_network_acl.protected[0].arn, null)
}
